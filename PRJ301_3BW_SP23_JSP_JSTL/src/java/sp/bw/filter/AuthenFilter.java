...
public class AuthenFilter implements Filter {
    ...
    private static List<String>  US_RESOURCE ;
    private static List<String>  AD_RESOURCE ;
    ...
    public AuthenFilter() {
        ...
        US_RESOURCE.add("user.jsp");
        US_RESOURCE.add("shopping.jsp");
        US_RESOURCE.add("viewCart.jsp");
        
        AD_RESOURCE = new ArrayList<>();
        AD_RESOURCE.add("admin.jsp");
        ...
        NON_AUTHEN_RESOURCE.add("LoginGmailController");
                NON_AUTHEN_RESOURCE.add("CheckOut.jsp");


//        NON_AUTHEN_RESOURCE.add("user.jsp");
        ...
        try {
            ...
            if(checkContain){
                ...
                if(session == null || session.getAttribute("LOGIN_USER")== null){
                    ...
                    if(AD.equals(roleID) && AD_RESOURCE.contains(resource)){
                        chain.doFilter(request, response);
                    }else if(US.equals(roleID) && US_RESOURCE.contains(resource)){
                        chain.doFilter(request, response);
                    }else{
                        res.sendRedirect(LOGIN_PAGE);
                    }
